  ...
  return (
    <div className='min-h-screen bg-gray-50 max-w-full sm:h-[1900px] md:h-[1100px] lg:h-[770px]'>
      ...
      <div className=" grid lg:grid-cols-3 gap-[10px] md:grid-cols-2 sm:grid-rows-1 relative space-x-1">
        ...
        <img src="Image 2.jpg" alt="description" className='bg-cover bg-center lg:w-[400px] h-[500px] left-[1px] lg:ml-32 md:ml-20 sm:ml-32 mt-[4px]' />
        ...
        <div className='relative bg-cover bg-center sm:justify-center sm:items-center'>
        <img src="/Image 3.jpg" alt="description" className='bg-cover bg-center w-[400px] lg:w-[350px] h-[500px] left-[1px] lg:ml-28 md:ml-20 sm:ml-32 mt-[4px]' />
        ...
        <div className='relative grid md:grid-cols-2 lg:grid-cols-1 bg-cover bg-center sm:justify-center sm:items-center'>
          <img src="/Image 4.jpg" alt="description" className='bg-cover bg-center sm:mr-60 w-[400px] lg:w-[239px] sm:h-[300px] lg:h-[242px] lg:ml-20 md:ml-40 sm:ml-32 mt-[4px] '/>
          <h5 className='font-montserrat font-bold bg-white absolute top-96 md:top-40 w-[170px] h-[48px] left-[20px] sm:top-[230px] lg:left-[110px] md:left-[170px] sm:left-[150px] flex items-center justify-center'>
          ACCESSORIES
        </h5>
        <div className='relative bg-cover bg-center sm:justify-center sm:items-center '>
        <img src="/Image 5.jpg" alt="description" className='bg-cover bg-center w-[400px] lg:w-[239px] sm:h-[300px] lg:h-[242px] lg:ml-20 md:ml-[400px] sm:ml-32 mt-[16px]'/>
        <h5 className='font-montserrat font-bold bg-white absolute top-[400px] lg:right-40 md:top-44 w-[120px] h-[48px] sm:top-[230px] left-[20px] lg:left-[110px] md:left-[420px] sm:left-[160px] flex items-center justify-center '>
          KIDS
        </h5>
        </div>
        </div>

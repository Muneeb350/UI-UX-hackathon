  ...
  return (
    <div className='min-h-screen bg-gray-50 max-w-full sm:h-[1900px] md:h-[1100px] lg:h-[770px]'>
      ...
      <div className=" grid lg:grid-cols-3 gap-[10px] md:grid-cols-2 sm:grid-rows-1 relative space-x-1">
        ...
        <img src="Image 2.jpg" alt="description" className='bg-cover bg-center lg:w-[480px] h-[500px] left-[1px] lg:ml-32 md:ml-20 sm:ml-32 mt-[4px]' />
        ...
        <div className='relative bg-cover bg-center sm:justify-center sm:items-center'>
        <img src="/Image 3.jpg" alt="description" className='bg-cover bg-center w-[400px] lg:w-[350px] h-[500px] left-[1px] lg:ml-32 md:ml-20 sm:ml-32 mt-[4px]' />
        ...
        <div className='relative grid md:grid-cols-2 lg:grid-cols-1 bg-cover bg-center sm:justify-center sm:items-center'>
          <img src="/Image 4.jpg" alt="description" className='bg-cover bg-center sm:mr-60 w-[400px] lg:w-[239px] sm:h-[300px] lg:h-[242px] lg:ml-24 md:ml-40 sm:ml-32 mt-[4px] '/>
        ...
        <div className='relative bg-cover bg-center sm:justify-center sm:items-center '>
        <img src="/Image 5.jpg" alt="description" className='bg-cover bg-center w-[400px] lg:w-[239px] sm:h-[300px] lg:h-[242px] lg:ml-24 md:ml-[400px] sm:ml-32 mt-[16px]'/>

...
const Product = () => {
  return (
    // Parent start
    <div className='w-full pt-5 lg:h-[1400px] md:h-[2800px] sm:h-[5100px] h-[5200px]'>
       ...
       {/* Text Area */}
        ...
        <div className='container pt-16 ml-6 justify-center items-center grid lg:grid-cols-4 lg:h-[615px] md:h-[1500px]  gap-[10px] md:grid-cols-2 sm:grid-rows-0 '>
          ...
          <div className='container pt-16 justify-center ml-6 grid lg:grid-cols-4 h-[615px] gap-[10px] md:grid-cols-2 sm:grid-rows-0'>
            {/* image 5 start */}
               <div className='w-[250px] h-[615px] gap-[30px]'>
